...
/**
 * PATTERN: Segmented 6-Box OTP Input Component
 * STACK: React 18/19, Tailwind CSS v4
 * 
 * FEATURES:
 * - 6 discrete cells with active focus border and focus ring
 * - Auto-advances to next input on digit keystroke
 * - Backspace jumps focus to previous cell
 * - Handles paste event (sanitizes non-digits and fills all 6 boxes)
 * - Auto-triggers onComplete callback immediately upon 6th digit entry
 */
